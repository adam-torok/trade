        ...
        <div class="border-t bg-white border-gray-200 px-4 p-4 mb-2 sm:mb-0">
            <div class="relative flex">
                ...
                >
                    ...
                    <button
                        type="button"
                        class="inline-flex items-center justify-center rounded-full h-12 w-12 transition duration-500 ease-in-out text-white bg-gray-500 hover:bg-gray-400 focus:outline-none"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 20 20"
