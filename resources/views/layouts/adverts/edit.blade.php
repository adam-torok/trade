...
<div class="container mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
    <form enctype="multipart/form-data" method="POST" action="{{ route('advert.edit', $advert->id) }}">
        @csrf
        @method('PATCH')
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input 
                class="appearance-none block w-full bg-grey-lighter @error('title') border-red-500 @enderror text-grey-darker border  rounded py-3 px-4 mb-3"
                value="{{ $advert->title }}" 
                autofocus 
                id="grid-title"
                type="text"
        ...
        <div class="-mx-3 md:flex mb-6">
            <div class="md:w-full px-3">
                ...
                type="text"
                name="description"
                placeholder="Hirdetesed leirasa roviden, max 255 karakter">
                {{ $advert->title }}
                </textarea>
                @error('description')
                <span class="invalid-feedback" role="alert">
        ...
        <div class="-mx-3 px-3 md:flex mb-6">
            <div class=" mb-2 border relative bg-gray-100 mb-4 shadow-inset">
                <img id="profile_iamge_preview" class="object-cover w-full h-32" src="storage/{{ $advert->image }}" />
        ...
        <div class="-mx-3 md:flex mb-2">
            ...
            <div class="md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                name="price"
                value="{{ $advert->price }}"
                placeholder="Ird be az osszeget">
                @error('price')
                <span class="invalid-feedback" role="alert">
                    <p class="text-red-500 text-xs italic">{{$message}}</p>
                </span>
