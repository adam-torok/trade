...
<div class="h-screen w-screen bg-gray-100 flex items-center">
    <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
        <div class="max-w-md">
            ...
            <p class="text-2xl md:text-3xl font-light leading-normal">Sajnos ezt az oldalt nem talaltuk meg...</p>
            <p class="mb-8">De ne aggodj, van meg oldal amit nezegethetsz</p>
            <button class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700">Vissza a fooldalra</button>
        </div>
        <div class="max-w-lg">
