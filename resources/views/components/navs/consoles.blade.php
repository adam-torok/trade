<nav class="bottom-nav p-2 fixed bottom-0 w-full border bg-white flex overflow-x-auto">
    <a href="{{route('adverts.xbox')}}" class="p-2 flex cursor-pointer flex-col flex-grow items-center justify-center
    ...
    <a href="{{route('adverts.ps')}}" class="p-2 cursor-pointer flex flex-col flex-grow items-center justify-center
        overflow-hidden whitespace-no-wrap text-sm transition-colors duration-100
        ease-in-out hover:bg-blue-200 focus:text-blue-500">
        <i class="text-blue-500 fab fa-playstation fa-lg"></i>
    </a>
    <a href="{{route('adverts.nintendo')}}" class="p-2 flex cursor-pointer flex-col flex-grow items-center justify-center
	overflow-hidden whitespace-no-wrap text-sm transition-colors duration-100
