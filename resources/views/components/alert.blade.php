    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
        ...
        <div class="mt-8 lex lg:mt-0 lg:flex-shrink-0">
            ...
            @else
            <div class="inline-flex rounded-md shadow">
                <a href="{{route('advert.create')}}" class="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700">
                    Hirdetes feladása
                </a>
            </div>
            @endguest
